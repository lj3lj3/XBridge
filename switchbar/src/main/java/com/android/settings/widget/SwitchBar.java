...
//        int switchBarMarginEnd = (int) a.getDimension(1, 0);
        int switchBarMarginStart = (int)getResources().getDimension(R.dimen.switchbar_subsettings_margin_start);
        int switchBarMarginEnd = (int)getResources().getDimension(R.dimen.switchbar_subsettings_margin_end);
//        a.recycle();
