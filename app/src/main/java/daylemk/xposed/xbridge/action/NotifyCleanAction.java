 ...
 * the action of package: de.defim.apk.notifyclean
 */
public class NotifyCleanAction extends Action {
    ...
    public static void loadPreferenceKeys(Resources sModRes) {
        ...
        keyShowInRecentTask = sModRes.getString(R.string.key_notifyclean_recent_task);
        keyShowInStatusBar = sModRes.getString(R.string.key_notifyclean_status_bar);
        // get the default value of this action
        showInStatusBarDefault = sModRes.getBoolean(R.bool.notifyclean_status_bar_default);
        showInRecentTaskDefault = sModRes.getBoolean(R.bool.notifyclean_recent_task_default);
        showInAppInfoDefault = sModRes.getBoolean(R.bool.notifyclean_app_info_default);
